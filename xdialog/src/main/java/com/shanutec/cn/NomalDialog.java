 ...
 */
public class NomalDialog extends Dialog {

    public NomalDialog(Context context) {
        super(context);
    }

    public NomalDialog(Context context, int theme) {
        super(context, theme);
    }
    ...
    public static class Builder {
        ...
        public NomalDialog create() {
            LayoutInflater inflater = (LayoutInflater) context
                    .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            // instantiate the dialog with the custom Theme
            final NomalDialog dialog = new NomalDialog(context, R.style.NomalDialog);
            dialog.setCanceledOnTouchOutside(TouchOutside);
            View layout = inflater.inflate(R.layout.lt_nomal, null);
